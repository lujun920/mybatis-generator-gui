...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        // 生成批量批量保存方法
        if (context.getJavaClientGeneratorConfiguration().getNeedBatchSaveConf()) {
            addBatchSaveElement(answer);
        }
    ...
    protected void addBatchSaveElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateInsert()) {
            AbstractXmlElementGenerator elementGenerator = new BatchSaveElementGenerator(true);
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
